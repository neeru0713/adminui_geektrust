...
describe('Navbutton', () => {
  ...
  it('should render correctly', () => {
    const { getByText } = render(<Navbutton NavbuttonHandler={mockNavbuttonHandler} pageNumber={pageNumber} page={page} />);
  ...
  it('should have whitebg class when pageNumber equals page', () => {
    const { getByText } = render(<Navbutton NavbuttonHandler={mockNavbuttonHandler} pageNumber={page} page={page} />);
    const buttonElement = getByText(page.toString());
