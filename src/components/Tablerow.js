...
function Tablerow({
    ...
    return (
        ...
        <tr className={selectedRows.includes(index) ? "graybg w100" : "w100"}>
            ...
            <td>
                {editingRow === index? (<input getindex={index} onChange={updateRowItem} type="text" name="name" placeholder="Modify Text"/>):data.name}
            </td>
            <td>
                {editingRow === index? (<input getindex={index} onChange={updateRowItem} type="text" name="email" placeholder="Modify Text"/>):data.email}
            </td>
            <td>
                {editingRow === index? (<input getindex={index} onChange={updateRowItem} type="text" name="role" placeholder="Modify Text"/>):data.role}
            </td>
